...
const navItems = [
  ...
  { title: "Products", href: "/admin/products", icon: Package },
  {
    ...
    children: [
      ...
      { title: "Payment Gateways", href: "/admin/gateways" },
      { title: "Payments God Mode", href: "/admin/payments-god-mode" },
      { title: "Dunning", href: "/admin/dunning" },
      { title: "Proration", href: "/admin/proration" },
      { title: "Entitlements", href: "/admin/entitlements" },
      { title: "Multi-Currency", href: "/admin/currency" },
      { title: "Licenses", href: "/admin/licenses" },
    ],
  },
