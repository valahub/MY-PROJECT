          ...
          <section className="bg-gradient-to-br from-primary/10 via-background to-accent/10 py-16 md:py-24">
            <div className="container mx-auto px-4 text-center">
              ...
              <div className="flex items-center justify-center gap-4 text-sm text-muted-foreground">
                <span>Popular:</span>
                <Link to="/marketplace/category/wordpress" className="text-primary hover:underline">
                  WordPress
                </Link>
                <Link to="/marketplace/category/html-templates" className="text-primary hover:underline">
                  HTML Templates
                </Link>
                <Link to="/marketplace/category/ecommerce" className="text-primary hover:underline">
                  eCommerce
                </Link>
              </div>
            </div>
